 ...
 */
class Types extends \MainBundle\Entity\Types implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MainBundle\\Entity\\Types' . "\0" . 'type', '' . "\0" . 'MainBundle\\Entity\\Types' . "\0" . 'idType'];
        }
