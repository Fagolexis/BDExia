 ...
 */
class Dates extends \MainBundle\Entity\Dates implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Dates $proxy) {
    ...
    public function setTypeDate(\MainBundle\Entity\Types $typeDate = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTypeDate', [$typeDate]);

        return parent::setTypeDate($typeDate);
    }
    ...
    public function getTypeDate()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTypeDate', []);

        return parent::getTypeDate();
    }
